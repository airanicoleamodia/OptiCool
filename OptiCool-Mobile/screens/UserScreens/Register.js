...
import { Avatar, Button, Text, HelperText, TextInput } from 'react-native-paper';
            ...
            >
                {({
                    ...
                    <>
                        ...
                        {avatar !== null ?
                            <Avatar.Image source={{ uri: avatar }} size={125} style={styles.avatarPreview} />
                            :
                            <Avatar.Icon icon={'account'} size={125} style={styles.avatarPreview} />
                        }

                        <Button icon={avatar ? "delete" : "camera"} mode="outlined" onPress={() => {
                        ...
                        <View style={{ flexDirection: 'row', gap: 5, paddingHorizontal: 5, marginTop: 10 }}>
                            <Text style={{ alignSelf: 'center' }}>Already have an account?</Text>
                            <Text variant='labelLarge' onPress={() => navigation.navigate('Login')}>Login</Text>
                        </View>
                    </>
                )}
            </Formik>
