...
import { View, Text, StyleSheet, TouchableOpacity, Modal, Pressable, ImageBackground, Image, ScrollView } from 'react-native';
...
export default function Dashboard() {
    ...
    const fetchWeatherData = async () => {
        ...
        try {
            ...
            const { data } = await axios.get(`${AccuweatherbaseURL}/currentconditions/v1/${locationKey}`, {
                params: {
                    apikey: apiKey,
                    language: 'en-us',
                    details: true,
                ...
                {isDropdownVisible && (
                    ...
                    >
                        ...
                        <View style={styles.dropdown}>
                            <TouchableOpacity onPress={() => handleOptionSelect('Profile')} style={styles.dropdownItem}>
